...
if (!defined('LLM_TRACE_CLEANER_VERSION')) {
    ...
    define('LLM_TRACE_CLEANER_VERSION', '1.8.5');
...
if (!class_exists('LLM_Trace_Cleaner')) {
    ...
    private function load_dependencies() {
        ...
        require_once LLM_TRACE_CLEANER_PLUGIN_DIR . 'includes/class-llm-trace-cleaner-unicode.php';
        ...
        require_once LLM_TRACE_CLEANER_PLUGIN_DIR . 'includes/class-llm-trace-cleaner-image-c2pa.php';
